...
from challenges.ch06_arrays.solutions.ex05_jewels_board_init import init_jewels_board, check_board_validity
from challenges.ch06_arrays.intro.intro import print_array
